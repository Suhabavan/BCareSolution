...
export class ClusterComponent implements OnInit {
  ...
  constructor(private http: HttpClient,private router:Router) {
    this.percentage= sessionStorage.getItem('probability')+"%";
    this.category = "Cluster-"+sessionStorage.getItem('userCluster');
  }
  ...
  public data1:number[]=JSON.parse(sessionStorage.getItem('dataSet'));
